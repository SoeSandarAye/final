...
<div class="container" style="margin-top: 100px">
  <div class="row"> 
    ...
    <div class="offset-md-1 col-md-10 bg-white shadow">
      <div class="row">
        <div class="col-md-3 bg-secondary" style="padding-top: 100px;">
      ...
      @endforeach
        ...
        <div class="col-md-9 py-5">
            <h4 class="text-center font-weight-bold"><i class="fas fa-user-edit"></i>Update Password</h4><hr>
      ...
      <form method="POST" action="{{route('updatepassword.update',$usernames->id)}}">
        @csrf
        @method('PUT')
        @foreach($userdetails as $userdetail)
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control {{ $errors->has('oldpass') ? ' is-invalid' : '' }}"  name="oldpass">
        ...
        <div class="form-group">
          ...
          <input type="password" class="form-control" id="formGroupExampleInput2"  name="newpass">
        </div>
          ...
          <div class="row">
            ...
            <div class="offset-md-8 col-md-4">
              <button type="submit" class="btn btn-primary" style="background-color: #4d636f"><i class="fas fa-user-edit"></i>Update Password</button>
            </div>
          </div>
          @endforeach
      </form>
